{
  "categories": {
    "Machine Learning": {
      "trending_focus": "Machine Learning: SOTA comparisons, datasets, compute, energy cost, reproducibility.",
    ...
    "Natural Language Processing": {
      "trending_focus": "Natural Language Processing: eval metrics (BLEU/ROUGE/EM/Hallucination risk), dataset biases, safety.",
    ...
    "Computer Vision": {
      "trending_focus": "Computer Vision: datasets (ImageNet/COCO/medical), segmentation/tracking benchmarks, edge vs cloud deployment.",
    ...
    "Robotics": {
      "trending_focus": "Robotics: sim2real, ISO safety standards, real deployments.",
    ...
    "Generative AI": {
      "trending_focus": "Generative AI: model provenance, licensing, watermarking, detectability.",
    ...
    "AI Applications": {
      "trending_focus": "AI Applications: enterprise ROI, integration case studies, deployment cost.",
    ...
    "AI Research": {
      "trending_focus": "AI Research: arXiv/NeurIPS/CVPR papers, ablations, reproducibility, code availability.",
    ...
    "AI Ethics": {
      "trending_focus": "AI Ethics: audits, impact assessments, governance, legal cases.",
