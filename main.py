...
def run_pipeline(category, config, forced_keyword=None, is_cluster_topic=False):
    ...
    Integrated with Truth Verification and Data Visualization.
    """
    ...
    try:
        ...
        try:
            ...
            if "benchmark" in target_keyword.lower() or "vs" in target_keyword.lower() or "price" in target_keyword.lower():
                ...
                REQUIREMENTS:
                - Find at least 2 entities with comparable numerical values (Scores, Prices, Speed, Parameters).
                ...
                OR return null if no data found.
                """
