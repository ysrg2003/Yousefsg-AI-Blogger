...
# UPDATED: Programmatically wraps AI sources in a beautiful CSS box.
...
class AdvancedContentValidator:
    ...
    # --- NEW FUNCTION: STYLE AI SOURCES ---
    def style_ai_generated_sources(self, html_content):
        """
        Finds the plain 'Sources' section generated by AI and wraps it
        in a beautiful div container (.ai-sources-box).
        """
        soup = BeautifulSoup(html_content, 'html.parser')
        
        # Keywords to identify the sources section
