...
1. "headline": "A catchy, clickable title (NOT clickbait, but intriguing)."
...
3. "article_body": "The main content HTML. Must include: <h2>What's Happening</h2>, <ul>Quick Summary</ul>, [[TOC_PLACEHOLDER]], <h2>Deep Dive</h2> (Detailed analysis). Use <h3> for sub-sections. Do NOT include the Verdict here."
4. "verdict": "<h2>The Verdict (My Take)</h2><p>Your expert opinion/conclusion based on all data.</p>"
...
**CONTEXT:**
The input JSON contains separate parts of an article: 'headline', 'hook', 'article_body', and 'verdict'.
...
2. **Styling Wrappers (Match CSS):**
   ...
   - **NEW:** Find the "Verdict" section and wrap it in: `<blockquote>...</blockquote>` to make it stand out.
...
6. **Sources:**
   - Add `<div class="Sources">` listing titles of sources with their links.
...
4. **Formatting:** Ensure the `takeaways-box` and `toc-box` classes are preserved.
